...
namespace Alps\Kiyoh\Model\Config;
...
class CronConfig extends \Magento\Framework\App\Config\Value
{
     ...
     * Cron string path
     */
    const CRON_STRING_PATH = 'crontab/default/jobs/alps_kiyoh/schedule/cron_expr';

    /**
     * Cron model path
     */
    const CRON_MODEL_PATH = 'crontab/default/jobs/alps_kiyoh/run/model';
